...
import com.example.sms.naver.SmsRequest;
...
public class SmsService {
    ...
    public SmsResponse sendSms(String recipientPhoneNumber, String content) throws UnsupportedEncodingException, NoSuchAlgorithmException, InvalidKeyException, JsonProcessingException, URISyntaxException {
        Long time = System.currentTimeMillis();
        List<MessagesDto> messages = new ArrayList<>();
        messages.add(new MessagesDto(recipientPhoneNumber, content));

        SmsRequest smsRequest = new SmsRequest("SMS", "COMM", "82", fromNumber, "내용", messages);
